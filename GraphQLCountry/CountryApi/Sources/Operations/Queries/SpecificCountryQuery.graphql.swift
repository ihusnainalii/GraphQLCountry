...
public class SpecificCountryQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query SpecificCountry { country(code: "PK") { __typename name code capital currencies continent { __typename name } native states { __typename name code } languages { __typename name } awsRegion subdivisions { __typename name } phone emoji } }"#
    ))
